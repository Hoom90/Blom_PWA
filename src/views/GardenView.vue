...
async function getData() {
    hasData.value = true
    loading.value = true
    await fetch(serverURL + "/api/flowers/" + localStorage.getItem('userId'))
    .then((res)=>res.json())
    .then((data) => {
        if(data.length != 0){
            if(init){
        ...
        <div v-else class="overflow-y-auto h-[92svh] bg-[#49B77914] relative">
            ...
            <div class="fixed p-[20px] max-w-[400px] w-full h-[90svh]">
                <div class="flex flex-col gap-5 h-full">
                    ...
                    <div v-if="!hasData && !userData" class="flex flex-col justify-center items-center h-[90svh]">
                        <i>
            ...
            <!-- flex -->
            <div class="mt-[108%] relative max-w-[400px]" v-if="hasData && userData">
